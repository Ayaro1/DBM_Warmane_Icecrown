...
local specWarnSuppressorOne		= mod:NewSpecialWarning("Suppressors", not mod:IsHealer())
local specWarnSuppressorTwo		= mod:NewSpecialWarning("Suppressors", not mod:IsHealer())
local specWarnSuppressorThree	= mod:NewSpecialWarning("Suppressors", not mod:IsHealer())
local specWarnSuppressorFour	= mod:NewSpecialWarning("Suppressors", not mod:IsHealer())
...
local timerSuppressorOne		= mod:NewTimer(30, "1st wave of Suppressors", not mod:IsHealer())
local timerSuppressorTwo		= mod:NewTimer(58, "2nd wave of Suppressors", not mod:IsHealer())
local timerSuppressorThree		= mod:NewTimer(68, "3rd wave of Suppressors", not mod:IsHealer())
local timerSuppressorFour		= mod:NewTimer(50, "4th wave of Suppressors", not mod:IsHealer())
...
function mod:OnCombatStart(delay)
	...
	table.wipe(GutSprayTargets)
	blazingSkeleton = nil
	timerSuppressorOne:Start(-delay)
	timerSuppressorTwo:Schedule(30)
	timerSuppressorThree:Schedule(88)
	timerSuppressorFour:Schedule(150)
	specWarnSuppressorOne:Schedule(30)
	specWarnSuppressorTwo:Schedule(88)
	specWarnSuppressorThree:Schedule(150)
	specWarnSuppressorFour:Schedule(200)
end
